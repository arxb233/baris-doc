import{_ as e,c as p,j as a,a as t,G as i,a4 as l,B as c,o}from"./chunks/framework.DbLu_ZlF.js";const f=JSON.parse('{"title":"windows下使用Certbot申请通配符证书","description":"","frontmatter":{"title":"windows下使用Certbot申请通配符证书","date":"2023-10-18T13:31:55.000Z","tags":null,"top_img":"https://www.myfreax.com/content/images/size/w816/2019/07/certbot.webp","cover":"https://www.myfreax.com/content/images/size/w816/2019/07/certbot.webp"},"headers":[],"relativePath":"baris/obsidian/cerebot/certbot.md","filePath":"baris/obsidian/cerebot/certbot.md","lastUpdated":1735102267000}'),r={name:"baris/obsidian/cerebot/certbot.md"};function d(h,s,u,b,g,m){const n=c("ArticleMetadata");return o(),p("div",null,[s[0]||(s[0]=a("h1",{id:"windows下使用certbot申请通配符证书",tabindex:"-1"},[t("windows下使用Certbot申请通配符证书 "),a("a",{class:"header-anchor",href:"#windows下使用certbot申请通配符证书","aria-label":'Permalink to "windows下使用Certbot申请通配符证书"'},"​")],-1)),i(n),s[1]||(s[1]=l(`<div class="tip custom-block"><p class="custom-block-title">转载说明</p><p>本文档转发为<a href="https://zhuanlan.zhihu.com/p/627526278%EF%BC%8C%E5%A6%82%E4%BE%B5%E6%9D%83%E8%81%94%E7%B3%BB%E5%88%A0%E9%99%A4" target="_blank" rel="noreferrer">https://zhuanlan.zhihu.com/p/627526278，如侵权联系删除</a></p></div><div class="warning custom-block"><p class="custom-block-title">改文档已过时</p><p>2024年2月Certbot停止了对Windows端的维护,可以自行配置，如果图方便可以使用windows宝塔面板</p></div><h2 id="一、下载并安装软件" tabindex="-1">一、下载并安装软件 <a class="header-anchor" href="#一、下载并安装软件" aria-label="Permalink to &quot;一、下载并安装软件&quot;">​</a></h2><p>在这个网站下载最新的软件并安装 <img src="https://pic1.zhimg.com/80/v2-0f1de0a1cfd872d02d533c1b5f0a97a8_720w.webp" alt="avater" loading="lazy"></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>https://github.com/certbot/certbot/</span></span></code></pre></div><p>下载完成后直接双击安装就行了</p><p>安装完成后，以管理员方式运行cmd，输入cretbot --version，如果有显示就说明安装成功了</p><div class="language-bat vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bat</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">C:\\Windows\\System32</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">certbot --version certbot 2.5.0</span></span></code></pre></div><p>命令行工具使用说明</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>用法:</span></span>
...
<span class="line"><span>- This certificate will not be renewed automatically. Autorenewal of --manual certificates requires the use of an authentication hook script (--manual-auth-hook) but one was not provided. To renew this certificate, repeat this same certbot command before the certificate&#39;s expiry date.</span></span></code></pre></div><p>翻译过来就是说：</p><p>下一个步骤:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>—该证书不会自动更新。——manual证书的自动更新需要使用身份验证挂钩脚本(——manual-auth-hook)，但没有提供。要更新该证书，请在证书到期之前重复相同的certbot命令。</span></span></code></pre></div><p>我理解就是如果下次经续签，可能就是要重新申请一次。反正也不麻烦，大概几分钟就搞定了，那就下次再重新申请吧。</p>`,36))])}const k=e(r,[["render",d]]);export{f as __pageData,k as default};
